...
class CWR(ConanFile):
    ...
    def requirements(self):
        ...
        # Resolve version conflict between openal-soft and sdl for libalsa
    ...
    def configure(self):
        ...
        # Studio UI tests requires ImGui Test Engine
        self.options["imgui"].enable_test_engine = True

        # Build openal-soft as a shared library
